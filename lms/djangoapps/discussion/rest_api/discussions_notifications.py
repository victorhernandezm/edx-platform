...
class DiscussionNotificationSender:
    ...
    def _send_course_wide_notification(self, course_id, notification_type, audience_filters=None, extra_context=None):
        """
    ...
    def send_new_thread_created_notification(self, course_id):
        """
        ...
        self._send_course_wide_notification(course_id, notification_type, audience_filters, context)
