...
from openedx.core.djangoapps.course_roles.helpers import use_permission_checks
...
class CourseRolesUserRoleAdmin(DisableCourseRolesAdminMixin, admin.ModelAdmin):
