...
class AdminCourseRolesUserRoleTest(SharedModuleStoreTestCase):
    ...
    ADMIN_URLS = (
        ('get', reverse('admin:course_roles_courserolesuserrole_add')),
        ('get', reverse('admin:course_roles_courserolesuserrole_changelist')),
        ('get', reverse('admin:course_roles_courserolesuserrole_change', args=(1,))),
        ('get', reverse('admin:course_roles_courserolesuserrole_delete', args=(1,))),
        ('post', reverse('admin:course_roles_courserolesuserrole_add')),
        ('post', reverse('admin:course_roles_courserolesuserrole_changelist')),
        ('post', reverse('admin:course_roles_courserolesuserrole_change', args=(1,))),
        ('post', reverse('admin:course_roles_courserolesuserrole_delete', args=(1,))),
    )
